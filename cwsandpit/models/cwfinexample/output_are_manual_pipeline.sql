...
records_id::text||'|'||records_fields_financial_sub_category::text as _nk_transin,
...
substring(records_fields_cob_class_code,1,1)                    as AE_DIMENSION_4,
records_fields_target_market                                    as AE_DIMENSION_5,
'000'                                                           as AE_DIMENSION_6,
records_fields_placing_basis                                    as AE_DIMENSION_7,
pm.contracttypecode                                             as AE_DIMENSION_8,
null                                                            as AE_DIMENSION_9,
null                                                            as AE_DIMENSION_10,
substring(records_fields_cob_class_code,6,50)                   as AE_DIMENSION_11,
...
records_fields_financial_sub_category                           as CLIENT_TEXT5,
...
null                                                            as LOCAL_CU_CURRENCY_ISO_CODE
    ...
    from architecture_db.cw_are_airtable.pipelinefile_pipelinefile pl
    
        join cwsandpit.dim_dates d 
            on d.date = '2021-11-16'
           
        join cwsandpit.placingbasismapping pm
            on pl.records_fields_placing_basis = pm.placingbasiscode
    
        join cwsandpit.dim_financial_categories fc
            on pl.records_fields_financial_sub_category = fc.sub_category
