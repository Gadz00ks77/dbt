...
select * 
from {{ref('output_are_contract_transaction_in_union_presit')}}
union all
select * 
from {{ref('output_are_manual_presit_ibnr')}}
-- union all
-- select * 
-- from {{ref('output_are_manual_mm')}}
union all
select * 
from {{ref('output_are_manual_presit_pipeline')}}
union all
select * 
from {{ref('output_are_manual_presit_rip')}}
...
t.CLIENT_TEXT7, -- Claim Reference
...
t.CLIENT_TEXT13,
t.CLIENT_TEXT14,
ifnull(t.CLIENT_TEXT15,'n/a') as CLIENT_TEXT15, -- Claim Peril (n/a for None)
t.CLIENT_TEXT16,
t.CLIENT_TEXT17,
t.CLIENT_TEXT18,
t.CLIENT_TEXT19,
