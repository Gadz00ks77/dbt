...
'RESERVING_CLASS'       as SRGC_GCT_CODE_TYPE_ID,
r.LINEREF               as SRGC_CLIENT_CODE,
sha2(r.RESERVESEGMENT)  as SRGC_CLIENT_TEXT1,
...
r.RESERVESEGMENT        as SRGC_DESCRIPTION,
'A'                   as SRGC_ACTIVE,
...
from {{ref('targetmarket_mapping')}} r