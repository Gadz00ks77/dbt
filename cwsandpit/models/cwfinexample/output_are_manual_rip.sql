...
records_id||'|'||records_fields_financial_category                as _nk_transin,
...
records_fields_settlement_currency_iso_code                     as CU_CURRENCY_ISO_CODE,
...
case when records_fields_financial_category   = 'Premium' then 'Premium' else 'Deduction' end as CLIENT_TEXT3,
case when records_fields_financial_category   = 'Premium' then 'Premium' else 'Brokerage' end as CLIENT_TEXT4,
records_fields_financial_category                               as CLIENT_TEXT5,
'N'                                                             as CLIENT_TEXT6,
'n/a'                                                           as CLIENT_TEXT7,
'n/a'                                                           as CLIENT_TEXT8,
records_fields_original_currency_iso_code                       as CLIENT_TEXT9,
...
pl.records_fields_original_currency_amount                      as CLIENT_AMOUNT1,
pl.records_fields_settlement_currency_amount                    as CLIENT_AMOUNT2,
...
null                                                            as LOCAL_CU_CURRENCY_ISO_CODE
    ...
    from architecture_db.cw_are_airtable.ripestimatesfile_ripestimatesfile pl
    
        join cwsandpit.dim_dates d 
            on d.date = '2021-11-16'
           
        left join at_position ap
            on pl.records_fields_policy_line_reference = ap.policy_reference
        
        left join cwsandpit.targetmarket_mapping tm
            on pl.records_fields_policy_line_reference = tm.lineref